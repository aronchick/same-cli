...
import (
	"github.com/azure-octo/same-cli/pkg/sameconfig"
...
// LoadSameConfig loads a SAME config according to the spec
func (v V1) LoadSameConfig(def interface{}) (*sameconfig.SameConfig, error) {
	...
	config := &sameconfig.SameConfig{
		TypeMeta:   v1.TypeMeta{},
		ObjectMeta: v1.ObjectMeta{},
		Spec:       sameconfig.Spec{},
	}
