...
var (
	...
	DEPENDENCY_CHECKER_MISSING_PYTHON_PACKAGES_PROBE  string = "dependency-checker-missing-python-packages"
	DEPENDENCY_CHECKER_MISSING_PYTHON_PACKAGES_RESULT string = "DEPENDENCY CHECKER MISSING PYTHON PACKAGES NOT DETECTED"
